          ...
          <div class="container grid px-6 mx-auto">
            ...
            Team Picture
                ...
                <input type="file"  name="image"
                  class="block w-full mt-2 mb-2 px-4 py-3 text-sm border-black-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"
                  placeholder="Jane Doe"
                />
                <div>
                <button class=" px-4 py-2  text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue" name="upload">
                upload
                </button>
            </div>
            <?php 
            ...
            if (isset($_POST['upload'])) {
              ...
              $folder = "team/".$filename;
                  ...
                  $user=$_SESSION['username'];
                  $sql = "UPDATE agency SET team_picture =  '$filename' WHERE full_name='$user' ";
            ...
            >
            Showcase your talented team and origin story.
            </h4>
