...
$sql = "SELECT type_user FROM users WHERE type_user='Client' AND username='$user'";
...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Dashboard - Agency Dashboard</title>
    <link
        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <?php 
             ...
             $user=$_SESSION['username'];
             $sql ="SELECT * FROM agency WHERE full_name='$user' ORDER BY Id DESC";
             $result=mysqli_query($con,$sql);
             if (mysqli_num_rows($result) > 0) {
              // output data of each row
              ...
              >
                <div class="flex items-center">
                  ...
                  <span>See my agency profile </span>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <?php 
                    $user=$_SESSION['username'];
                    $sql = "SELECT * from agency WHERE full_name='$user' AND service=(SELECT service FROM client WHERE adress=(SELECT place From client WHERE username='$user')";
