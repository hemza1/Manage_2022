...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>SortList - Agency Dashboard</title>
    <link
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="pages/404.php">
                      Reviews
                    </a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="pages/blank.php">
                      Works
                    </a>
                  </li>
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="pages/contact.php">
                      Contact
                    </a>
                  </li>
...
<?php } ?>
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            >
            Show prospects where you can help them by listing your areas of expertise. The order in which you set your services will have an impact on the opportunities we select for you. Make sure to move the services for which you want to get more opportunities at the top of the list.
            </h4>
            <div
            ...
            >
              <p class="text-sm text-gray-600 dark:text-gray-400">
                <?php
                  $user=$_SESSION['username'];
                  $sql="SELECT service FROM agency WHERE full_name='$user'";
